...
function createDox(
  ...
  const worksheet = XLSX.utils.aoa_to_sheet([
    ...
    ...(MM22 !== 0 ? [["Теплоизоляционные трубки 22 мм", "0.44 $", MM22, MM22Total + " $"]] : []),
    ...(MM25 !== 0 ? [["теплоизоляционные трубки 25 мм", "0.45 $", MM25, MM25Total + " $"]] : []),
    ...(MM28 !== 0 ? [["теплоизоляционные трубки 28 мм", "0.47 $", MM28, MM28Total + " $"]] : []),
    ...(MM32 !== 0 ? [["теплоизоляционные трубки 32 мм", "0.62 $", MM32, MM32Total + " $"]] : []),
