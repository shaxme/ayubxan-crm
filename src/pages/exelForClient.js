...
export default function createDoxForClient(
  ...
  const worksheet = XLSX.utils.aoa_to_sheet([
    ...
    ...(MM16 !== 0 ? [["Теплоизоляционные трубки 16 мм", "0.32 $", MM16 + "m", MM16Total + " $"]] : []),
    ...(MM20 !== 0 ? [["Теплоизоляционные трубки 20 мм", "0.36 $", MM20 + "m", MM20Total + " $"]] : []),
    ...(MM22 !== 0 ? [["Теплоизоляционные трубки 22 мм", "0.37 $", MM22 + "m", MM22Total + " $"]] : []),
    ...(MM25 !== 0 ? [["теплоизоляционные трубки 25 мм", "0.44 $", MM25 + "m", MM25Total + " $"]] : []),
    ...(MM28 !== 0 ? [["теплоизоляционные трубки 28 мм", "0.45 $", MM28 + "m", MM28Total + " $"]] : []),
    ...(MM32 !== 0 ? [["теплоизоляционные трубки 32 мм", "0.47 $", MM32 + "m", MM32Total + " $"]] : []),
    ...(MM40 !== 0 ? [["теплоизоляционные трубки 40 мм", "0.62 $", MM40 + "m", MM40Total + " $"]] : []),
    ...(MM50 !== 0 ? [["теплоизоляционные трубки 50 мм", "0.90 $", MM50 + "m", MM50Total + " $"]] : []),
    ...(MM63 !== 0 ? [["теплоизоляционные трубки 63 мм", "1.22 $", MM63 + "m", MM63Total + " $"]] : []),
